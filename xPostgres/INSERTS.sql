...
('afiliacionproveedorC'),
('afiliacionproveedorU'),
('afiliacionproveedorD'),
('privilegioCRUD'),
('privilegioC'),
('privilegioU'),
('privilegioD'),
...
('asistenciaView'),
('totalpuntosView'),
('lugarCRUD'),('lugarC'),('lugarU'),('lugarD'),
('proveedorCRUD'),('proveedorC'),('proveedorU'),('proveedorD'),
('actividadCRUD'),('actividadC'),('actividadU'),('actividadD'),
('entradaCRUD'),('entradaC'),('entradaU'),('entradaD'),
('evento_proveedorCRUD'),('evento_proveedorC'),('evento_proveedorU'),('evento_proveedorD'),
('telefonoCRUD'),('telefonoC'),('telefonoU'),('telefonoD'),
('emailCRUD'),('emailC'),('emailU'),('emailD'),
('personacontactoCRUD'),('personacontactoC'),('personacontactoU'),('personacontactoD'),
('almacenCRUD'),('almacenC'),('almacenU'),('almacenD'),
('anaquelCRUD'),('anaquelC'),('anaquelU'),('anaquelD'),
('pasilloCRUD'),('pasilloC'),('pasilloU'),('pasilloD'),
('tipocervezaCRUD'),('tipocervezaC'),('tipocervezaU'),('tipocervezaD'),
('horarioCRUD'),('horarioC'),('horarioU'),('horarioD'),
('tiendaCRUD'),('tiendaC'),('tiendaU'),('tiendaD'),
...
('caracteristicasC'),
('tasacambiariaC'),
('tasa_monedaextranjeraC'),
('punto_puntovalorC'),
('tipocerveza_ingredienteC'),
('revistaC'),
('ventaC'),
('puntocompraC'),
('detalleventaC'),
...
('comntarioC'),
('puntoventaC'),
('afiliacion_estatuspagoC'),
('estatuspagoC'),
('empleado_beneficioC'),
('faltaC'),
('pasopreparacionC'),
('proveedor_tipocervezaC'),
('imagencervezaC'),
('efectivoU'),
('bancoU'),
('tarjetadebitoU'),
...
('caracteristicasU'),
('tasacambiariaU'),
('tasa_monedaextranjeraU'),
('punto_puntovalorU'),
('tipocerveza_ingredienteU'),
('revistaU'),
('ventaU'),
('puntocompraU'),
('detalleventaU'),
...
('comntarioU'),
('puntoventaU'),
('afiliacion_estatuspagoU'),
('estatuspagoU'),
('empleado_beneficioU'),
('faltaU'),
('pasopreparacionU'),
('proveedor_tipocervezaU'),
('imagencervezaU'),
('efectivoD'),
('bancoD'),
('tarjetadebitoD'),
...
('caracteristicasD'),
('tasacambiariaD'),
('tasa_monedaextranjeraD'),
('punto_puntovalorD'),
('tipocerveza_ingredienteD'),
('revistaD'),
('ventaD'),
('puntocompraD'),
('detalleventaD'),
