                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Rif</th><th>Nombre</th><th>Apellido</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($clientenatural as $item)
                                    <tr>
                            ...
                            <div class="pagination-wrapper"> {!! $clientenatural->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
